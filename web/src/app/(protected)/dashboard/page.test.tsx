...
describe('DashboardPage', () => {
    it('renders compact status chips, four overview cards, and the setup card', () => {
        ...
        expect(screen.getByText('Open systems')).toBeVisible();
        expect(screen.getByText('Open services')).toBeVisible();
        expect(screen.getByText('Open VM workspace')).toBeVisible();
        expect(screen.getByText('Open my requests')).toBeVisible();
        ...
        expect(screen.getByText('Next VM')).toBeVisible();
        expect(screen.getByText('vm-1.internal · openEuler · 10.0.0.1')).toBeVisible();
