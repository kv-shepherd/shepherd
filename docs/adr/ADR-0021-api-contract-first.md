...
| Date | Author | Change |
|------|--------|--------|
| 2026-02-28 | @jindyzhao | Append ADR-0037 amendment block (runtime canonical spec source, validator lifecycle, compat scope, CI ordering) |
...
### ADR-0037: OpenAPI Validation Architecture and Enforcement Policy (2026-02-28)
