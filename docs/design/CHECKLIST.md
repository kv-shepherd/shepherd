...
| [ADR-0057](../adr/ADR-0057-opentelemetry-and-correlation-logging-baseline.md) | OpenTelemetry tracing is default-off HTTP ingress only with W3C propagation; deep spans require later ADRs | Runtime observability | Unit tests + code review |
