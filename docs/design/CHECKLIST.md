...
| Phase 1 | [checklist/phase-1-checklist.md](./checklist/phase-1-checklist.md) | [phases/01-contracts.md](./phases/01-contracts.md) | 🔄 Partial (~98%) — 33 Ent schemas + Ent codegen sync/dynamic-query safety gates + TS/Go API types + ADR-0028 generated-type gate + frontend testing toolchain + cluster credential runtime + provider plugin config boundary ✅, remaining work is Ent schema/transaction/test standards and deferred V2 schemas |
...
| Phase 1 | 🔄 Partial (~98%) | - | 33 Ent schemas + Ent codegen sync/dynamic-query safety gates + Go/TS API types + ADR-0028 generated-type gate + frontend testing toolchain + cluster credential runtime + provider plugin config boundary done; Ent schema/transaction/test standards and deferred V2 schemas remain |
