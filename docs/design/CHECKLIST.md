...
| Phase 1 | 🔄 Partial (~98%) | - | 33 Ent schemas + Ent codegen sync gate + Go/TS API types + ADR-0028 generated-type gate + frontend testing toolchain + cluster credential runtime + provider plugin config boundary done; Ent standards and deferred V2 schemas remain |
