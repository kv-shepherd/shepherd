...
| `kubevirt.io/api` | `v1.8.4` | KubeVirt API types |
| `kubevirt.io/client-go` | `v1.8.4` | Official KubeVirt client |
...
series used by the KubeVirt `v1.8.4` baseline. Do not upgrade one Kubernetes
