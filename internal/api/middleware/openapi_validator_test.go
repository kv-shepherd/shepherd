...
func TestOpenAPIValidatorAllowsBrowserRuntimeHeadersInStrictMode(t *testing.T) {
	...
	req.Header.Set("Origin", "https://example-preview-3000.app.github.dev")
	req.Header.Set("Referer", "https://example-preview-3000.app.github.dev/login")
	...
	req.Header.Set("X-Forwarded-Host", "example-preview-3000.app.github.dev")
	req.Header.Set("X-Forwarded-Port", "3000")
	req.Header.Set("X-Forwarded-Proto", "https")
	req.Header.Set("Forwarded", "for=198.51.100.24;proto=https;host=example-preview-3000.app.github.dev")
	req.Header.Set("X-Forwarded-Server", "codespaces-proxy")
	req.Header.Set("X-Original-Host", "example-preview-3000.app.github.dev")
...
func TestOpenAPIValidatorAllowsProxyTransportHeadersOnNonAuthRoutes(t *testing.T) {
	...
	req.AddCookie(&http.Cookie{Name: "example-preview-session", Value: "signed-session"})
