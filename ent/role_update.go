...
func (_u *RoleUpdate) AddRoleBindingIDs(ids ...string) *RoleUpdate {
...
func (_u *RoleUpdate) RemoveRoleBindingIDs(ids ...string) *RoleUpdate {
...
// AddRoleBindingIDs adds the "role_bindings" edge to the RoleBinding entity by IDs.
func (_u *RoleUpdateOne) AddRoleBindingIDs(ids ...string) *RoleUpdateOne {
	_u.mutation.AddRoleBindingIDs(ids...)
	return _u
}
...
// RemoveRoleBindingIDs removes the "role_bindings" edge to RoleBinding entities by IDs.
func (_u *RoleUpdateOne) RemoveRoleBindingIDs(ids ...string) *RoleUpdateOne {
	_u.mutation.RemoveRoleBindingIDs(ids...)
	return _u
}
