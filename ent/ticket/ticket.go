...
func OperationTypeValidator(ot OperationType) error {
	switch ot {
	case OperationTypeCREATE, OperationTypeMODIFY, OperationTypeDELETE, OperationTypePOWER, OperationTypeVNC_ACCESS:
		return nil
	default:
		return fmt.Errorf("ticket: invalid enum value for operation_type field: %q", ot)
	}
}
