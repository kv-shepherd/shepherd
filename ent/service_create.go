...
func (_c *ServiceCreate) SetNextInstanceIndex(v int) *ServiceCreate {
	_c.mutation.SetNextInstanceIndex(v)
	return _c
}

// SetNillableNextInstanceIndex sets the "next_instance_index" field if the given value is not nil.
func (_c *ServiceCreate) SetNillableNextInstanceIndex(v *int) *ServiceCreate {
	if v != nil {
		_c.SetNextInstanceIndex(*v)
	}
	return _c
}
...
func (_c *ServiceCreate) defaults() {
	...
	if _, ok := _c.mutation.NextInstanceIndex(); !ok {
		v := service.DefaultNextInstanceIndex
		_c.mutation.SetNextInstanceIndex(v)
	}
}
...
func (_c *ServiceCreate) check() error {
	...
	if _, ok := _c.mutation.NextInstanceIndex(); !ok {
		return &ValidationError{Name: "next_instance_index", err: errors.New(`ent: missing required field "Service.next_instance_index"`)}
	}
	if v, ok := _c.mutation.NextInstanceIndex(); ok {
	...
	if len(_c.mutation.SystemIDs()) == 0 {
		return &ValidationError{Name: "system", err: errors.New(`ent: missing required edge "Service.system"`)}
	}
	return nil
}
...
func (_c *ServiceCreate) createSpec() (*Service, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.NextInstanceIndex(); ok {
		_spec.SetField(service.FieldNextInstanceIndex, field.TypeInt, value)
		_node.NextInstanceIndex = value
	}
