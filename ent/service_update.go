...
func (_u *ServiceUpdate) SetNextInstanceIndex(v int) *ServiceUpdate {
	_u.mutation.ResetNextInstanceIndex()
	_u.mutation.SetNextInstanceIndex(v)
	return _u
}

// SetNillableNextInstanceIndex sets the "next_instance_index" field if the given value is not nil.
func (_u *ServiceUpdate) SetNillableNextInstanceIndex(v *int) *ServiceUpdate {
	if v != nil {
		_u.SetNextInstanceIndex(*v)
	}
	return _u
}

// AddNextInstanceIndex adds value to the "next_instance_index" field.
func (_u *ServiceUpdate) AddNextInstanceIndex(v int) *ServiceUpdate {
	_u.mutation.AddNextInstanceIndex(v)
	return _u
}

// SetSystemID sets the "system" edge to the System entity by ID.
func (_u *ServiceUpdate) SetSystemID(id string) *ServiceUpdate {
	_u.mutation.SetSystemID(id)
	return _u
}

// SetSystem sets the "system" edge to the System entity.
func (_u *ServiceUpdate) SetSystem(v *System) *ServiceUpdate {
	return _u.SetSystemID(v.ID)
}

// AddVMIDs adds the "vms" edge to the VM entity by IDs.
func (_u *ServiceUpdate) AddVMIDs(ids ...string) *ServiceUpdate {
	_u.mutation.AddVMIDs(ids...)
	return _u
}

// AddVms adds the "vms" edges to the VM entity.
func (_u *ServiceUpdate) AddVms(v ...*VM) *ServiceUpdate {
...
func (_u *ServiceUpdate) ClearSystem() *ServiceUpdate {
	_u.mutation.ClearSystem()
	return _u
}

// ClearVms clears all "vms" edges to the VM entity.
func (_u *ServiceUpdate) ClearVms() *ServiceUpdate {
	_u.mutation.ClearVms()
	return _u
}

// RemoveVMIDs removes the "vms" edge to VM entities by IDs.
func (_u *ServiceUpdate) RemoveVMIDs(ids ...string) *ServiceUpdate {
	_u.mutation.RemoveVMIDs(ids...)
	return _u
}

// RemoveVms removes "vms" edges to VM entities.
func (_u *ServiceUpdate) RemoveVms(v ...*VM) *ServiceUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *ServiceUpdate) check() error {
	if v, ok := _u.mutation.NextInstanceIndex(); ok {
		if err := service.NextInstanceIndexValidator(v); err != nil {
			return &ValidationError{Name: "next_instance_index", err: fmt.Errorf(`ent: validator failed for field "Service.next_instance_index": %w`, err)}
		}
	}
	if _u.mutation.SystemCleared() && len(_u.mutation.SystemIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Service.system"`)
	}
	return nil
}
...
func (_u *ServiceUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.NextInstanceIndex(); ok {
		_spec.SetField(service.FieldNextInstanceIndex, field.TypeInt, value)
	}
	if value, ok := _u.mutation.AddedNextInstanceIndex(); ok {
		_spec.AddField(service.FieldNextInstanceIndex, field.TypeInt, value)
	}
	if _u.mutation.SystemCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   service.SystemTable,
			Columns: []string{service.SystemColumn},
			Bidi:    false,
	...
	if _u.mutation.VmsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   service.VmsTable,
			Columns: []string{service.VmsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// SetNextInstanceIndex sets the "next_instance_index" field.
func (_u *ServiceUpdateOne) SetNextInstanceIndex(v int) *ServiceUpdateOne {
	_u.mutation.ResetNextInstanceIndex()
	_u.mutation.SetNextInstanceIndex(v)
	return _u
}
...
// SetNillableNextInstanceIndex sets the "next_instance_index" field if the given value is not nil.
func (_u *ServiceUpdateOne) SetNillableNextInstanceIndex(v *int) *ServiceUpdateOne {
	if v != nil {
		_u.SetNextInstanceIndex(*v)
	}
	return _u
...
// AddNextInstanceIndex adds value to the "next_instance_index" field.
func (_u *ServiceUpdateOne) AddNextInstanceIndex(v int) *ServiceUpdateOne {
	_u.mutation.AddNextInstanceIndex(v)
	return _u
}

// SetSystemID sets the "system" edge to the System entity by ID.
func (_u *ServiceUpdateOne) SetSystemID(id string) *ServiceUpdateOne {
	_u.mutation.SetSystemID(id)
	return _u
}

// SetSystem sets the "system" edge to the System entity.
func (_u *ServiceUpdateOne) SetSystem(v *System) *ServiceUpdateOne {
	return _u.SetSystemID(v.ID)
}

// AddVMIDs adds the "vms" edge to the VM entity by IDs.
func (_u *ServiceUpdateOne) AddVMIDs(ids ...string) *ServiceUpdateOne {
	_u.mutation.AddVMIDs(ids...)
	return _u
}

// AddVms adds the "vms" edges to the VM entity.
func (_u *ServiceUpdateOne) AddVms(v ...*VM) *ServiceUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSystem clears the "system" edge to the System entity.
func (_u *ServiceUpdateOne) ClearSystem() *ServiceUpdateOne {
	_u.mutation.ClearSystem()
	return _u
}

// ClearVms clears all "vms" edges to the VM entity.
func (_u *ServiceUpdateOne) ClearVms() *ServiceUpdateOne {
	_u.mutation.ClearVms()
	return _u
}

// RemoveVMIDs removes the "vms" edge to VM entities by IDs.
func (_u *ServiceUpdateOne) RemoveVMIDs(ids ...string) *ServiceUpdateOne {
	_u.mutation.RemoveVMIDs(ids...)
	return _u
}

// RemoveVms removes "vms" edges to VM entities.
func (_u *ServiceUpdateOne) RemoveVms(v ...*VM) *ServiceUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
