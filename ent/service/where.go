...
// NextInstanceIndex applies equality check predicate on the "next_instance_index" field. It's identical to NextInstanceIndexEQ.
func NextInstanceIndex(v int) predicate.Service {
	return predicate.Service(sql.FieldEQ(FieldNextInstanceIndex, v))
}
...
// NextInstanceIndexEQ applies the EQ predicate on the "next_instance_index" field.
func NextInstanceIndexEQ(v int) predicate.Service {
	return predicate.Service(sql.FieldEQ(FieldNextInstanceIndex, v))
}

// NextInstanceIndexNEQ applies the NEQ predicate on the "next_instance_index" field.
func NextInstanceIndexNEQ(v int) predicate.Service {
	return predicate.Service(sql.FieldNEQ(FieldNextInstanceIndex, v))
}

// NextInstanceIndexIn applies the In predicate on the "next_instance_index" field.
func NextInstanceIndexIn(vs ...int) predicate.Service {
	return predicate.Service(sql.FieldIn(FieldNextInstanceIndex, vs...))
}

// NextInstanceIndexNotIn applies the NotIn predicate on the "next_instance_index" field.
func NextInstanceIndexNotIn(vs ...int) predicate.Service {
	return predicate.Service(sql.FieldNotIn(FieldNextInstanceIndex, vs...))
}

// NextInstanceIndexGT applies the GT predicate on the "next_instance_index" field.
func NextInstanceIndexGT(v int) predicate.Service {
	return predicate.Service(sql.FieldGT(FieldNextInstanceIndex, v))
}

// NextInstanceIndexGTE applies the GTE predicate on the "next_instance_index" field.
func NextInstanceIndexGTE(v int) predicate.Service {
	return predicate.Service(sql.FieldGTE(FieldNextInstanceIndex, v))
}

// NextInstanceIndexLT applies the LT predicate on the "next_instance_index" field.
func NextInstanceIndexLT(v int) predicate.Service {
	return predicate.Service(sql.FieldLT(FieldNextInstanceIndex, v))
}

// NextInstanceIndexLTE applies the LTE predicate on the "next_instance_index" field.
func NextInstanceIndexLTE(v int) predicate.Service {
	return predicate.Service(sql.FieldLTE(FieldNextInstanceIndex, v))
}

// HasSystem applies the HasEdge predicate on the "system" edge.
func HasSystem() predicate.Service {
...
func HasSystemWith(preds ...predicate.System) predicate.Service {
	return predicate.Service(func(s *sql.Selector) {
		step := newSystemStep()
...
func HasVmsWith(preds ...predicate.VM) predicate.Service {
	return predicate.Service(func(s *sql.Selector) {
		step := newVmsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
