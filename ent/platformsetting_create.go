...
func (_c *PlatformSettingCreate) SetUpdatedBy(v string) *PlatformSettingCreate {
...
func (_c *PlatformSettingCreate) check() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "PlatformSetting.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
	...
	if _, ok := _c.mutation.UpdatedBy(); !ok {
		return &ValidationError{Name: "updated_by", err: errors.New(`ent: missing required field "PlatformSetting.updated_by"`)}
	}
